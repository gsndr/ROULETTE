...
def CNN2(images, y, params=None):
    ...
    X = Conv2D(32, (k2, kernel), activation='relu', name='conv0', kernel_initializer='glorot_uniform')(inputs)
    X = Dropout(rate=params['dropout1'])(X)
    X = Conv2D(64, (k2, kernel), activation='relu', name='conv1',kernel_initializer='glorot_uniform')(X)
    X = Dropout(rate=params['dropout2'])(X)
    X = Conv2D(128, (k2, kernel), activation='relu', name='conv2',kernel_initializer='glorot_uniform')(X)
    X = Flatten()(X)
